//Base de datos con toda la información del cliente comprador, contiene datos del user id, el usuario, nombre comleto, dirección, correo electrónico y número de celular.
